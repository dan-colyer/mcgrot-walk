...
`)}var PM={[Yu]:"Linear",[Zu]:"Reinhard",[Ku]:"Cineon",[$o]:"ACESFilmic",[Ju]:"AgX",[ju]:"Neutral",[$u]:"Custom"};function LM(i,e){let t=PM[e];return t===void 0?(ze("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var Sl=new L;function NM(){ht.getLuminanceCoefficients(Sl);let i=Sl.x.toFixed(4),e=Sl.y.toFixed(4),t=Sl.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter(ca).join(`
`)),o=Eh(o),o=Up(o,t),o=Op(o,t),a=Eh(a),a=Up(a,t),a=Op(a,t),o=Bp(o),a=Bp(a),t.isRawShaderMaterial!==!0&&(_=`#version 300 es
